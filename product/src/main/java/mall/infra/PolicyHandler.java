...
public class PolicyHandler{
    ...
    public void wheneverDeliveryReturned_IncreaseStok(@Payload DeliveryReturned deliveryReturned){

        DeliveryReturned event = deliveryReturned;
        System.out.println("\n\n##### listener IncreaseStok : " + deliveryReturned + "\n\n");


        

        // Sample Logic //
        Inventory.increaseStok(event);
